import numpy as np
from tokenizer import tokenize_f
...
# Model and test
desc_tree=IsolationForest(max_features=6, contamination=0.10125, n_estimators=108)
...
dump(desc_tree, 'backend/models/net_one.joblib')
